...
### Attio setup
if you don't already have an account with Attio you can sign up for a free account at 
[https://app.attio.com/welcome/sign-in](https://app.attio.com/welcome/sign-in)
